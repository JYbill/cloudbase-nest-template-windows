...
/***/ "./src/common/pojo/result.pojo.ts":
/*!****************************************!*\
  !*** ./src/common/pojo/result.pojo.ts ***!
  \****************************************/
...
"use strict";
eval("\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.Result = void 0;\r\nclass Result {\r\n    constructor({ code = 200, msg = 'ok.🚀', data = null }) {\r\n        this.code = code;\r\n        this.msg = msg;\r\n        this.data = data;\r\n    }\r\n    static sendSuccess(data) {\r\n        return new Result({ data });\r\n    }\r\n    static sendError(code, msg) {\r\n        return new Result({ code, msg });\r\n    }\r\n}\r\nexports.Result = Result;\r\nResult.forbid_msg = 'not authorize😐';\r\nResult.requestError_msg = 'request error, pls check your url or uri.👓';\r\n\n\n//# sourceURL=webpack://nest-starter/./src/common/pojo/result.pojo.ts?");
